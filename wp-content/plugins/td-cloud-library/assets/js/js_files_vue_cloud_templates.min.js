...
c.templatesCardData.mobile_templates)}}):(c.errors.push({type:"error",message:"tpl card set global tpl error: missing template id or invalid nonce"}),c.loading=!1)},error:function(b,a,c){console.log("%c"+c,"color: #dc2121c7")}})},addMobileTpl:function(a){var b=this;b.errors=[];void 0!==a&&(b.template=a);b.showMobileTplModal?b.template&&jQuery.ajax({type:"post",url:td_ajax_url,data:{action:"tdb_create_mobile_template",template_id:b.template,template_title:b.newMobileTplName,template_type:"page"===
b.templateType||"homepage"===b.templateType?"page":b.templateType,copyContent:b.copyContent?"1":"0",_nonce:window.tdb_globals.wpRestNonce},success:function(a){a=JSON.parse(a);"undefined"!==typeof a.mobile_template_id?(b.cancelAddNewMobTpl(),b.getTemplateCardData({callback:function(){"cpt_tax"===b.templateType?window.eventHub.$emit("refresh-cpt-tax",b.templatesCardData.templates,b.templatesCardData.mobile_templates):"cpt"===b.templateType&&window.eventHub.$emit("refresh-cpt",b.templatesCardData.templates,
b.templatesCardData.mobile_templates)}}),"page"===b.templateType?jQuery("body").trigger("tdb_ct_tpl_card_data_update_homepage"):"homepage"===b.templateType&&jQuery("body").trigger("tdb_ct_tpl_card_data_update_page")):(b.errors.push({type:a.type,message:"tpl card create mobile tpl error: "+a.msg}),b.cancelAddNewMobTpl())},error:function(b,a,e){console.log("%c"+e,"color: #dc2121c7")}}):b.showMobileTplModal=!0},setMobileTpl:function(a,b){var c=this;c.errors=[];jQuery.ajax({type:"post",url:td_ajax_url,
data:{action:"tdb_set_mobile_template",template_id:a,mobile_template_id:b,_nonce:window.tdb_globals.wpRestNonce},success:function(b){b=JSON.parse(b);_.isObject(b)&&!_.isUndefined(b.result)&&1===b.result?c.getTemplateCardData({callback:function(){"cpt_tax"===c.templateType?window.eventHub.$emit("refresh-cpt-tax",c.templatesCardData.templates,c.templatesCardData.mobile_templates):"cpt"===c.templateType&&window.eventHub.$emit("refresh-cpt",c.templatesCardData.templates,c.templatesCardData.mobile_templates)}}):
c.errors.push({type:b.type,message:"tpl card set mobile template error: "+b.msg})},error:function(b,a,c){console.log("%c"+c,"color: #dc2121c7")}})},cancelAddNewMobTpl:function(){this.newMobileTplName=this.template="";this.copyContent=this.showMobileTplModal=!1},setTemplateNameEditDisplay:function(){var a={},b={};this.templatesCardData.templates.length&&(this.templatesCardData.templates.forEach(function(c,d){a["tpl_name_edit_"+c.ID]=!1;b["tpl_name_edit_saving_"+c.ID]=!1}),this.templatesNameEditing=
a,this.templatesNameSaving=b)},templateRename:function(a){var b=this;b.errors=[];b.templatesNameEditing["tpl_name_edit_"+a.ID]=!b.templatesNameEditing["tpl_name_edit_"+a.ID];b.editedTplName=a.post_title;b.$nextTick(function(){Object.entries(b.templatesNameEditing).forEach(function(a){a[1]&&"undefined"!==typeof b.$refs[a[0]][0]&&b.$refs[a[0]][0].focus()})})},saveTemplateRename:function(a){var b=this;b.editedTplName!==a.post_title?(b.templatesNameSaving["tpl_name_edit_saving_"+a.ID]=!b.templatesNameSaving["tpl_name_edit_saving_"+
a.ID],jQuery.ajax({url:td_ajax_url,type:"post",data:{action:"tdb_change_template_name",template_id:a.ID,template_title:b.editedTplName,_nonce:window.tdb_globals.wpRestNonce},success:function(c){c=JSON.parse(c);"undefined"!==typeof c.template_id?(a.post_title=b.editedTplName,b.templatesNameSaving["tpl_name_edit_saving_"+a.ID]=!b.templatesNameSaving["tpl_name_edit_saving_"+a.ID],b.templatesNameEditing["tpl_name_edit_"+a.ID]=!b.templatesNameEditing["tpl_name_edit_"+a.ID],(b.templateType.startsWith("pa_")||
"woo_archive"===b.templateType||"woo_archive_tag"===b.templateType||"woo_archive_attribute"===b.templateType)&&jQuery("body").trigger("tdb_ct_tpl_card_data_update_woo_archive"),"cpt_tax"===b.templateType?window.eventHub.$emit("refresh-cpt-tax",b.templatesCardData.templates,b.templatesCardData.mobile_templates):"cpt"===b.templateType&&window.eventHub.$emit("refresh-cpt",b.templatesCardData.templates,b.templatesCardData.mobile_templates)):b.errors.push({type:c.type,message:"tpl card change template name error: "+
c.msg})},error:function(b,a,e){console.log("%c"+e,"color: #dc2121c7")}})):b.cancelTemplateRename(a)},cancelTemplateRename:function(a){this.templatesNameEditing["tpl_name_edit_"+a.ID]=!this.templatesNameEditing["tpl_name_edit_"+a.ID]},blur:function(a){a.target.blur()},templateDuplicate:function(a){var b=this,c="";switch(b.templateType){case "page":case "homepage":c="page";break;case "woo_archive_attribute":case "woo_archive_tag":c="woo_archive";break;default:c=b.templateType.startsWith("pa_")?"woo_archive":
b.templateType}b.errors=[];tdbApi.run({wpNonce:window.tdb_globals.wpRestNonce,cloudEndPoint:"td-cloud-library/new_template",post:{postId:a.ID,templateType:c,templateName:a.post_title,duplicateTemplate:!0},done:function(a){"undefined"!==typeof a.template_id?b.templateType.startsWith("pa_")||"woo_archive"===b.templateType||"woo_archive_tag"===b.templateType||"woo_archive_attribute"===b.templateType?jQuery("body").trigger("tdb_ct_tpl_card_data_update_woo_archive"):b.getTemplateCardData({callback:function(){"cpt_tax"===
b.templateType?window.eventHub.$emit("refresh-cpt-tax",b.templatesCardData.templates,b.templatesCardData.mobile_templates):"cpt"===b.templateType&&window.eventHub.$emit("refresh-cpt",b.templatesCardData.templates,b.templatesCardData.mobile_templates)}}):b.errors.push({type:"error",message:"tpl card duplicate template error: "+a.error})},error:function(b){console.log("td-cloud-library/new_template ( duplicate template ) - ERROR",b)}})},templateDelete:function(a,b){b=void 0===b?!1:b;var c=this;c.errors=
[];jQuery.ajax({type:"POST",url:td_ajax_url,data:{action:"tdb_delete_template",template_id:a,_nonce:window.tdb_globals.wpRestNonce},success:function(a){a=JSON.parse(a);"undefined"!==typeof a.template_id?(c.templateType.startsWith("pa_")||"woo_archive"===c.templateType||"woo_archive_tag"===c.templateType||"woo_archive_attribute"===c.templateType?jQuery("body").trigger("tdb_ct_tpl_card_data_update_woo_archive"):c.getTemplateCardData({callback:function(){"cpt_tax"===c.templateType?window.eventHub.$emit("refresh-cpt-tax",
c.templatesCardData.templates,c.templatesCardData.mobile_templates):"cpt"===c.templateType&&window.eventHub.$emit("refresh-cpt",c.templatesCardData.templates,c.templatesCardData.mobile_templates)}}),b&&("page"===c.templateType?jQuery("body").trigger("tdb_ct_tpl_card_data_update_homepage"):"homepage"===c.templateType&&jQuery("body").trigger("tdb_ct_tpl_card_data_update_page"))):c.errors.push({type:a.type,message:"tpl card delete template error: "+a.msg})},error:function(b,a,c){console.log("%c"+c,"color: #dc2121c7")}})},
refreshCpt:function(a,b){"cpt"===this.templateType&&("undefined"!==typeof a&&(this.templatesCardData.templates=a),"undefined"!==typeof b&&(this.templatesCardData.mobile_templates=b))},refreshCptTax:function(a,b){"cpt_tax"===this.templateType&&("undefined"!==typeof a&&(this.templatesCardData.templates=a),"undefined"!==typeof b&&(this.templatesCardData.mobile_templates=b))}},watch:{templatesCardData:function(){this.setTemplateNameEditDisplay()}},components:{modal:window.tdbCloudTemplatesVue.modal}};
window.tdbCloudTemplatesVue.modules_templates_card={template:'<div class="tdb-s-template-type-body">\n            \n            \x3c!-- tpl type --\x3e\n            \x3c!--<div style="padding: 12px 15px; color: orangered; font-weight: bold;">{{template_type}}</div>--\x3e\n\n            <div v-if="templatesCardData.templates.length" :class="[ \'tdb-templates\', \'tdb-s-content\', { \'tdb-s-content-loading\' : loading } ]">\n                <div class="tdb-templates-header">\n                    <div class="tdb-templates-header-item tdb-templates-header-item-name" style="text-align: left;">\n                        <span>Cloud Templates</span>\n                    </div>\n                </div>\n                <div v-for="template in templatesCardData.templates" :class="[ \'tdb-template-el\', { \'tdb-template-el-renaming\' : templatesNameEditing[\'tpl_name_edit_\' + template.ID] }, { \'tdb-template-el-renaming-saving\' : templatesNameSaving[\'tpl_name_edit_saving_\' + template.ID] } ]">\n                    <div class="tdb-template-el-title">\n                        <template v-if="templatesNameEditing[\'tpl_name_edit_\' + template.ID]">\n                            <input\n                                :id="\'tpl_name_edit_\' + template.ID"\n                                v-model="editedTplName"\n                                :ref="\'tpl_name_edit_\' + template.ID"\n                                @keyup.enter="templateRenameSave(template)"\n                                @keydown.esc="templateRenameCancel(template)"\n                                :placeholder="template.post_title"\n                                class="tdb-template-el-title-input"\n                            >\n                            <div class="tdb-template-el-title-btns">\n                                <i @click="templateRenameSave(template)" class="tdb-template-el-title-save td-icon-check" title="Save"></i>\n                                <i @click="templateRenameCancel(template)" class="tdb-template-el-title-cancel td-icon-modal-close" title="Cancel"></i>\n                            </div>\n                        </template>\n                        <template v-else>\n                            <span :title="template.post_title">{{template.post_title}}</span>\n                        </template>\n                    </div>\n                    <div class="tdb-template-el-wrap">\n                        <div class="tdb-template-el-icon">\n                            <div class="tdb-template-el-options">\n                                <div title="Edit template with tagDiv Composer" class="tdb-template-el-edit-composer">\n                                    <a :href="getTdcEditLink(template)" target="_blank">Edit with TD Composer</a>\n                                </div>\n                                <div v-if="template.edit_link" title="Edit template" class="tdb-template-el-edit">\n                                    <a :href="template.edit_link" target="_blank">Edit</a>\n                                </div>\n                                <div v-if="template.view_link" title="View template" class="tdb-template-el-view">\n                                    <a :href="template.view_link" target="_blank">View</a>\n                                </div>\n                                <div title="Rename template" class="tdb-template-el-rename" @click="templateRename(template)">Rename</div>\n                                <div title="Duplicate template" class="tdb-template-el-duplicate" @click="templateDuplicate(template)">Duplicate</div>\n                                <div title="Delete template" class="tdb-template-el-delete" @click="templateDelete(template.ID)">Delete</div>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n                \x3c!-- reload tpl card data btn --\x3e\n                <div @click="getTemplateCardData()" style="max-width: 100px; background-color: #2aabee; font-size: 10px; color: white; margin: 0 auto; text-align: center; cursor: pointer;">reload tpl card data</div>\n                \x3c!-- errors --\x3e\n                <div class="tdb-s-template-type-errors" v-if="errors.length">\n                    <div v-for="error in errors" :class="[\'tdb-s-notif\', \'tdb-s-notif-xxsm\', \'tdb-s-notif-\' + error.type]">\n                        <div class="tdb-s-notif-descr">{{ error.message }}</div>\n                    </div>\n                </div>\n            </div>\n            <div v-else class="tdb-templates tdb-no-templates-notif">\n                No cloud templates. Please import one or more templates from <b>Cloud Library</b>.\n            </div>\n            \n        </div>',
